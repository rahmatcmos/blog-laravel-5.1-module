...
<head>
	...
	<link rel="stylesheet" href="{{ Module::asset('blog:css/bootstrap.min.css') }}">
	<link rel="stylesheet" href="{{ Module::asset('blog:css/clean-blog.css') }}">
	<link rel="stylesheet" href="{{ Module::asset('blog:css/style.css') }}">
	<title>{{ $title }}</title>
...
<header class="intro-header" style="background-image: url('{{ Module::asset('blog:img/post-bg.jpg') }}')">
	<div class="container">
		<div class="row">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
				...
				<a href="#">
					<img class="img-responsive" src="{{ Module::asset('blog:img/post-sample-image.jpg') }}" alt="">
				</a>
